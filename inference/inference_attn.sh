...
BBOX_EXPANSION=5
MASK_DETECTION_TEMPERATURE=0.5
...
# Run inference
CUDA_VISIBLE_DEVICES=0 python inference_attn.py \
    ...
    --mask_detection_temperature "${MASK_DETECTION_TEMPERATURE}" \
    --enable_mask_detection \
